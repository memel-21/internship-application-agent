"""Minimal Streamlit interface for Milestone 1."""
...
from internship_agent.exceptions import CandidateProfileError, InternshipAgentError
...
def render_app(settings: Settings) -> None:
    ...
    st.caption("Milestone 1: profile loading, vacancy text capture, deterministic foundations.")
    ...
    st.info("AI extraction is intentionally disabled in Milestone 1. Demo mode is on by default.")
